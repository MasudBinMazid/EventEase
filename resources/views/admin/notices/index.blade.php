...
<div class="admin-page">
  ...
  <div class="stats-grid">
    <div class="stat-card">
      <div class="stat-number">{{ $notices->count() }}</div>
      <div class="stat-label">Total Notices</div>
    </div>
    <div class="stat-card">
      <div class="stat-number">{{ $notices->where('is_active', true)->count() }}</div>
